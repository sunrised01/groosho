...
export default function Edit({ postType, errors, users }) {
    ...
    const handleMoveToTrash = () => {
        // Inertia.put(route('posttype.movetrash', postType.id), {}, {
        //     onSuccess: () => {
        //         t('Post moved to trash successfully!');
        //     },
        //     onError: (error) => {
        //         // Handle error
                                                ...
                                                <div className="p-3 mt-5 pt-3 border-top bg-light">
                                                    <div className="d-flex justify-content-between align-items-center">
                                                        <div className="trash-btn">
                                                            <Link className="btn btn-link text-danger" onClick={handleMoveToTrash}>Move to Trash</Link>
                                                        </div>
                                                        {/* Submit Button */}
                                                        <button type="submit" className="btn btn-primary" disabled={processing}>
                                                            {processing ? (
                                                                ...
                                                                postType.status === 'publish' ? "Update" : "Publish"
                                                            )}
                                                        </button>
                                                    </div>
                                                </div>
